...
import org.springframework.cloud.function.web.mvc.FunctionController__BeanDefinitions;
import org.springframework.cloud.function.web.mvc.ReactorAutoConfiguration__BeanDefinitions;
 ...
 */
public class XfjNativeFunctionApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("xfjNativeFunctionApplication", XfjNativeFunctionApplication__BeanDefinitions.getXfjNativeFunctionApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("thymeleafConfiguration", ThymeleafConfiguration__BeanDefinitions.getThymeleafConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("templateResolver", ThymeleafConfiguration__BeanDefinitions.getTemplateResolverBeanDefinition());
    beanFactory.registerBeanDefinition("templateEngine", ThymeleafConfiguration__BeanDefinitions.getTemplateEngineBeanDefinition());
    beanFactory.registerBeanDefinition("request", XfjNativeFunctionApplication__BeanDefinitions.getRequestBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.cloud.function.context.config.ContextFunctionCatalogAutoConfiguration$JsonMapperConfiguration", ContextFunctionCatalogAutoConfiguration__BeanDefinitions.JsonMapperConfiguration__BeanDefinitions.getJsonMapperConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("jsonMapper", ContextFunctionCatalogAutoConfiguration__BeanDefinitions.JsonMapperConfiguration__BeanDefinitions.getJsonMapperBeanDefinition());
    beanFactory.registerBeanDefinition("org.springframework.cloud.function.context.config.ContextFunctionCatalogAutoConfiguration$PlainFunctionScanConfiguration", ContextFunctionCatalogAutoConfiguration__BeanDefinitions.PlainFunctionScanConfiguration__BeanDefinitions.getPlainFunctionScanConfigurationBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("org.springframework.cloud.function.web.mvc.FunctionController", FunctionController__BeanDefinitions.getFunctionControllerBeanDefinition());
    beanFactory.registerBeanDefinition("org.springframework.cloud.function.web.mvc.ReactorAutoConfiguration", ReactorAutoConfiguration__BeanDefinitions.getReactorAutoConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("functionHandlerMapping", ReactorAutoConfiguration__BeanDefinitions.getFunctionHandlerMappingBeanDefinition());
    beanFactory.registerBeanDefinition("functionStringConverter", ReactorAutoConfiguration__BeanDefinitions.getFunctionStringConverterBeanDefinition());
